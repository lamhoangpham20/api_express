...
Promise.all(
  [
      ...
      db.query(`CREATE TABLE IF NOT EXISTS plugger(
          id INT AUTO_INCREMENT PRIMARY KEY,
          digit VARCHAR(32), name VARCHAR(32), type VARCHAR(32), connector VARCHAR(32), free VARCHAR(32), electricity INT, image VARCHAR(256), address VARCHAR(32), city VARCHAR(32),
