...
router.post('/', (req, res) => {
    ...
    db.query('INSERT INTO plugger (digit, name, type, connector, electricity, image, free, address, city,lat,lng ) VALUES (?,?,?,?,?,?,?,?,?,?,?)',
    [req.body.digit, req.body.name, req.body.type, req.body.connector, req.body.electricity, req.body.image, req.body.free, req.body.address,req.body.city, req.body.lat,req.body.lng])
    .then(results => {
        console.log(results);
        res.sendStatus(201);
    })
